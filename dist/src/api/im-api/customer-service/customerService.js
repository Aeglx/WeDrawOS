...
const db = require('../../core/data-access/database');
...
class CustomerService {
   ...
   */
  async initialize() {
    await this.loadCustomerServiceUsers();
...
module.exports.initialize = customerService.initialize.bind(customerService);